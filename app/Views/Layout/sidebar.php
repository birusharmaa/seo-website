<div class="main-sidebar-body">
	<ul class="nav">
		...
		<li class="nav-item ">
			<a class="nav-link" href="<?php echo base_url('custom-insert') ?>"><span class="shape1"></span><span class="shape2"></span><i class="ti-plus sidemenu-icon"></i><span class="sidemenu-label">Custom Insert</span></a>
		</li>
		<li class="nav-item ">
