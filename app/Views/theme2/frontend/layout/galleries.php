...
?>
<section class="bg-gray-light-new py-2 py-30">
    <div class="container">
        <div class="row">
            <div class="text-center mb-5" data-aos="fade-up" data-aos-duration="1000">
                <h2><span class="text-color fw-bold">Gallery Images</span></h2>
            </div>
            <?php
            $i = 0;
            ...
            ?>
                <div class="col-md-4 mb-10" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                    <div class="inner-column m-2 card">
                        <div class="position-relative card-body px-0 pt-0 pb-0 w-100">
